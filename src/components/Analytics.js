  ...
  return (
    <div className="analytics">
      ...
      <div className="charts">
        <div className="chart">
          <h2>Estimates</h2>
          <Chart options={chartOptions} series={lineChartData} type="line" height={isMobile ? 200 : 300} />
        </div>
        <div className="chart">
          <h2>Amount of Estimates</h2>
          <Chart options={chartOptions} series={barChartData} type="bar" height={isMobile ? 200 : 300} />
        </div>
        <div className="chart">
          <h2>Estimates by Type</h2>
          <Chart options={chartOptions} series={pieChartData} type="pie" height={isMobile ? 200 : 300} />
        </div>
        <div className="chart">
